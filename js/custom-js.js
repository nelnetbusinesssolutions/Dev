<script type="text/javascript">(function() {var walkme = document.createElement('script'); walkme.type = 'text/javascript'; walkme.async = true; walkme.src = 'https://cdn.walkme.com/users/d602c113d7c947a48fbbe0f1eebcc0fa/test/walkme_d602c113d7c947a48fbbe0f1eebcc0fa_https.js'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(walkme, s); window._walkmeConfig = {smartLoad:true}; })();</script>
...
<script type="text/javascript" src="https://cdn.rawgit.com/carlwoodhouse/jquery.cookieBar/master/jquery.cookieBar.js"></script>
<script type="text/javascript">
	$(document).ready(function() {
	  $('.cookie-message.proc').cookieBar({ closeButton : '.my-close-button', hideOnClose: false });
	  $('.cookie-message.proc').on('cookieBar-close', function() { $(this).slideUp(); });
